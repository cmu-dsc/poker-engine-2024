...
if __name__ == "__main__":
    player1_process = subprocess.Popen(["python", "python_skeleton/player.py", "--port", "50051"])
    player2_process = subprocess.Popen(["python", "python_skeleton/player.py", "--port", "50052"])
